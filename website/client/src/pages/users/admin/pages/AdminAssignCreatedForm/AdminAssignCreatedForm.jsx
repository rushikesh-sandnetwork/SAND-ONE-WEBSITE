...
const AdminAssignCreatedForm = () => {
    ...
    const fetchPromoters = async () => {
        try {
            const response = await axios.get('https://sand-one-live.vercel.app /api/v1/promoter/fetchPromoters');
    ...
    const assignFormToPromoter = async (promoterId) => {
        try {
            const response = await axios.post('https://sand-one-live.vercel.app /api/v1/admin/assignCreatedForms', {
                formId,
                promoterId,
            });
    ...
    const unassignFormFromPromoter = async (promoterId) => {
        try {
            const response = await axios.post('https://sand-one-live.vercel.app /api/v1/admin/unassignCreatedForms', {
                formId,
                promoterId,
            });
